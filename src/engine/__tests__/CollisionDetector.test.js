...
import { checkCircleRectCollision, checkBallPaddleCollision, checkBallPowerUpCollision, checkCircleCircleCollision, isPointInRect, isPointInCircle, getCircleBounds, checkAABBCollision, getDistance, getDistanceSquared, } from '../CollisionDetector';
describe('CollisionDetector', () => {
    describe('checkCircleRectCollision', () => {
        it('should detect collision when circle overlaps rectangle', () => {
            ...
            const rect = { x: 45, y: 45, width: 20, height: 20 };
        ...
        it('should detect collision when circle touches rectangle edge', () => {
            const circle = { x: 30, y: 10, radius: 10 };
            const rect = { x: 0, y: 0, width: 20, height: 20 };
            const result = checkCircleRectCollision(circle, rect);
            expect(result.collided).toBe(true);
        });
        ...
        it('should calculate normal vector on collision', () => {
            ...
            if (result.normal) {
                ...
                const magnitude = Math.sqrt(result.normal.x ** 2 + result.normal.y ** 2);
    ...
    describe('checkAABBCollision', () => {
        ...
        it('should not detect separated rectangles', () => {
            const rect1 = { x: 0, y: 0, width: 100, height: 100 };
            const rect2 = { x: 200, y: 0, width: 100, height: 100 };
