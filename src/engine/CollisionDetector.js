 ...
 */
export function checkBallPaddleCollision(ball, paddle, paddleSizeMultiplier = 1) {
    const paddleHeight = paddle.height * paddleSizeMultiplier;
    const paddleY = paddleSizeMultiplier > 1
 ...
 * @returns True if collision detected
 */
export function checkBallPowerUpCollision(ball, powerUpX, powerUpY, powerUpRadius) {
 ...
 */
export function isPointInCircle(pointX, pointY, circle) {
 ...
 */
export function getCircleBounds(circle) {
    return {
