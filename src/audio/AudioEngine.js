...
export class AudioEngine {
    ...
    constructor() {
        ...
        Object.defineProperty(this, "musicGain", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "sfxGain", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "currentMusicSource", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "currentAmbientSource", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        ...
        Object.defineProperty(this, "musicBuffers", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Map()
        });
        Object.defineProperty(this, "sfxBuffers", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Map()
        ...
        Object.defineProperty(this, "audioLoaded", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
    ...
    async createProceduralMusic(trackType) {
    ...
    async createProceduralAmbient(ambientType) {
        const sampleRate = this.audioContext.sampleRate;
        const duration = 20;
    ...
    async createProceduralSFX(sfxId, effect) {
        const sampleRate = this.audioContext.sampleRate;
    ...
    achievementSound(t) {
        ...
        const arpeggio = (Math.sin(2 * Math.PI * 523 * t) * 0.5 +
    ...
    // MUSIC CONTROL
    // ═════════════════════════════════════════════════════════
    setTheme(themeName, crossFade = true) {
        if (!this.audioLoaded)
            return;
    ...
    async crossFadeTheme(newThemeName, newTheme) {
        ...
        this.musicGain.gain.linearRampToValueAtTime(this.getMusicGainValue(newTheme), this.audioContext.currentTime + fadeDuration / 1000);
    ...
    switchTheme(themeName, theme, startVolume) {
        if (!this.audioLoaded)
            return;
    ...
    playSoundEffect(soundId) {
        if (!this.audioLoaded || !this.settings.soundEnabled)
            return;
...
export function setAudioTheme(themeName) {
