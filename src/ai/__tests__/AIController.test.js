...
import { getAIConfig, predictBallPosition, calculateAITarget, updateAIPaddle, shouldReact, isBallApproaching, computeAIMove, } from '../AIController';
describe('AIController', () => {
    describe('getAIConfig', () => {
        ...
        it('should default to medium for invalid difficulty', () => {
            const config = getAIConfig('invalid');
            expect(config.speed).toBe(6.5);
            expect(config.reactionTime).toBe(12);
        });
    });
    ...
    describe('computeAIMove', () => {
        ...
        it('should handle multiple sequential updates', () => {
            ...
            for (let i = 0; i < 5; i++) {
                ...
                const result = computeAIMove(ball, tempPaddle, currentAIState, canvasHeight, 'medium', currentTime);
