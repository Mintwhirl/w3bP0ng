...
import { POWER_UP_TYPES, generateSpawnTimer, spawnPowerUp, updatePowerUpAnimation, checkPowerUpCollision, getPowerUpOwner, getPowerUpConfig, shouldSpawnPowerUp, updateAllPowerUps, findCollidingPowerUp, removePowerUp, } from '../PowerUpManager';
describe('PowerUpManager', () => {
    ...
    describe('spawnPowerUp', () => {
        ...
        it('should select random power-up type', () => {
            const powerUps = Array.from({ length: 20 }, () => spawnPowerUp(canvasWidth, canvasHeight));
        ...
        it('should randomize float parameters', () => {
            ...
            const different = powerUp1.floatOffset !== powerUp2.floatOffset ||
    ...
    describe('updatePowerUpAnimation', () => {
        ...
        it('should cap float radius at 80', () => {
            ...
            const updated = updatePowerUpAnimation(powerUp, canvasWidth, canvasHeight, 101000);
        ...
        it('should clamp position to canvas bounds', () => {
            ...
            const updated = updatePowerUpAnimation(edgePowerUp, canvasWidth, canvasHeight, 2000);
    ...
    describe('getPowerUpConfig', () => {
        ...
        it('should throw for unknown type', () => {
            expect(() => getPowerUpConfig('invalid')).toThrow('Unknown power-up type: invalid');
        });
    });
    ...
    describe('updateAllPowerUps', () => {
        ...
        it('should not mutate original array', () => {
            const powerUps = [spawnPowerUp(canvasWidth, canvasHeight, 1000)];
