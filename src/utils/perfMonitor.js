...
export class PerformanceMonitor {
    constructor() {
        ...
        Object.defineProperty(this, "frameTimeHistory", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "renderCalls", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        ...
        Object.defineProperty(this, "frame", {
            ...
            value: (currentTime) => {
                ...
                this.stats.averageFPS = Math.round(this.frameHistory.reduce((sum, fps) => sum + fps, 0) / this.frameHistory.length);
                // Track frame time
...
export function updateObjectCount(count) {
    perfMonitor.updateObjectCount(count);
}
export function updatePhysicsTime(time) {
...
// Development helper
export function logPerformanceMetrics(label) {
